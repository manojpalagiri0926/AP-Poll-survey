...
function Voter() {
  ...
  const columns = [
    ...
    { title: 'Residential_Status', dataIndex: 'Residential_Status', key: 'Residential_Status' },
    {
      ...
      key: 'actions',
      render: (text, record) => (
        <button onClick={() => handleUpdate(record)} className="btn btn-outline-success"><Link to = 'survey/'>Update</Link> </button>
      ),
    },
    ...
    <Header style={{ background: '#fff', textAlign: 'left', padding: '5px', border: '2px solid #dedddd', boxShadow: '5px #dedddd', color: 'blue' }}>
      ...
      <div className='container-fluid ml-3'>
        <div className='row '>
          ...
          <div className="shadow-lg p-3 col-md-3  bg-white rounded h-55" style={{marginTop:"7rem" ,width:"28rem"}}>
            <div className="row mt-5">
