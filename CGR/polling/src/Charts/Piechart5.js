...
const data = [
  { category: 'Residential', value: 40 },
  { category: 'Non-Residential', value: 55 },
 
];

const COLORS = ['#07be1f','#0C4491'];
...
const P4 = () => {
  return (
    <Card title="Survey Status" style={{ width: 450, marginTop: 16 ,marginLeft:40}}>
